...
public class Proceso {
    ...
    private int Metodo_Busqueda() {

        try {

            int opt = Integer.parseInt(JOptionPane.showInputDialog("Buscar por:\n 1) Cedula\n2)Serial"));
    
            if (opt < 0 || opt > 2) {

                cg.Mensaje("Por favor, ingrese una opcion valida");

                return Metodo_Busqueda();
            ...
            switch (opt) {
                ...
                case 2:
                    ...
                    if (Metodo_Busqueda() == 1 ) {
                        ...
                        String Cedula = cg.leerCadena2("Ingrese la cedula:");
                        ...
                        String Serial = cg.leerCadena2("Ingrese el serial:");
    ...
    private ArrayList<ESTUDIANTE_INGENIERIA> Registrar_Prestamo(ArrayList<COMPUTADOR_PORTATIL> Lista_Computadores, ArrayList<ESTUDIANTE_INGENIERIA> Lista_Estudiantes_Ingenieria) {
        ...
        String Cedula = cg.leerCadena2("Ingrese la cedula del estudiante: "), Serial;
        ...
        estudiante.setNombre(cg.leerCadena2("Ingrese el nombre: "));
        estudiante.setApellido(cg.leerCadena2("Ingrese el apellido: "));
        estudiante.setTelefono(cg.leerCadena2("Ingrese el telefono: "));
        ...
        do {
            ...
            Serial = cg.leerCadena2("Ingrese el serial: ");
    ...
    private ArrayList<ESTUDIANTE_INGENIERIA> Modificar_Prestamo(String cedula, ArrayList<COMPUTADOR_PORTATIL> Lista_Computadores, ArrayList<ESTUDIANTE_INGENIERIA> Lista_Estudiantes_Ingenieria) {
        ...
        for (int i = 0; i < Lista_Estudiantes_Ingenieria.size(); i++) {
            ...
            if (estudiante.getCedula().equals(cedula)) {
                ...
                estudiante.setNombre(cg.leerCadena2("Ingrese el nuevo nombre del prestamista(Antes " + estudiante.getNombre() + "):"));
                estudiante.setApellido(cg.leerCadena2("Ingrese el nuevo apellido del prestamista(Antes " + estudiante.getApellido() + "):"));
                estudiante.setTelefono(cg.leerCadena2("Ingrese el nuevo telefono del prestamista(Antes " + estudiante.getTelefono() + "):"));
    ...
    private void Menu_Interno(ArrayList<TABLETA_GRAFICA> Lista_Tabletas, ArrayList<ESTUDIANTE_DISENO> Lista_Estudiantes_Diseño, boolean esTableta) {
        ...
        private ArrayList<ESTUDIANTE_DISENO> Registrar_Prestamo(ArrayList<TABLETA_GRAFICA> Lista_Tabletas, ArrayList<ESTUDIANTE_DISENO> Lista_Estudiantes_Diseño, boolean esTableta) {
            ...
            estudiante.setApellido(cg.leerCadena2("Ingrese el apellido: "));
            estudiante.setTelefono(cg.leerCadena2("Ingrese el telefono: "));
            estudiante.setModalidad(cg.leerCadena2("Ingrese la modalidad: "));
        ...
        private ArrayList<ESTUDIANTE_DISENO> Modificar_Prestamo(String cedula, ArrayList<TABLETA_GRAFICA> Lista_Tabletas, ArrayList<ESTUDIANTE_DISENO> Lista_Estudiantes_Diseño, boolean esTableta) {
            ...
            for (int i = 0; i < Lista_Estudiantes_Diseño.size(); i++) {
                ...
                if (estudiante.getCedula().equals(cedula)) {
                    ...
                    estudiante.setApellido(cg.leerCadena2("Ingrese el nuevo apellido del prestamista(Antes " + estudiante.getApellido() + "):"));
                    estudiante.setTelefono(cg.leerCadena2("Ingrese el nuevo telefono del prestamista(Antes " + estudiante.getTelefono() + "):"));
                    estudiante.setModalidad(cg.leerCadena2("Ingrese la nueva modalidad del prestamista(Antes " + estudiante.getModalidad() + "):"));
